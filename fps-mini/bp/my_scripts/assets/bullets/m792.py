...
Asset = {
    ...
    'projectile': {
        ...
        'drag': 0.0038,                   # 空气阻力系数, 影响速度衰减 (0为无衰减)
        'caliber': '7.92',             # 口径标识 (string), 作为 customTag 传入 hurt 组件
    ...
    'payloads': [
        # 载荷1: 动能伤害 (几乎必选)
        {
            ...
            'damageCurve': 'curves.m792'             # 伤害随速度衰减曲线资源ID (asset uri)
        },
        # 载荷2: 爆炸 (可选)
        # {
        #     'type': 'explosive',
