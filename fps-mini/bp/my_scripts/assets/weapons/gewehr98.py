...
Asset = {
    ...
    'bolt': {
        ...
        'cuppedPortOpenTime': 0.72,    # 当膛内有实弹拉开枪机（退膛）需要的时间
        # 枪机打开/关闭动画
    ...
    'feed': {
        ...
        'ammoType': [ 'bullets.m792' ],     # 兼容的弹药Asset列表
        'reloadModes': [
            {
    ...
    'slots': [
        ...
        },
        {
            ...
            'attachmentAsset': 'attachments.appearance.gewehr98',
            'category': 'appearance_gewehr98',                   # 槽位分类, 自由字符串
