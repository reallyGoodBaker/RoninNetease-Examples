...
Asset = {
    ...
    'bolt': {
        ...
        # 手动循环模式相关：
        'shootRestoreTime': 0.2,    # 射击后到可以手拉枪机的时间
        'cuppedPortOpenBolt': 'bolt_open_cup_port',   # 当膛内有实弹拉开枪机（退膛）时播放的动画
        'cuppedPortOpenTime': 0.53,    # 当膛内有实弹拉开枪机（退膛）需要的时间
        # 枪机打开/关闭动画
        ...
        'boltCloseTime': 0.32,       # 枪机从完全打开回到关闭的时间
        # 通用属性：
    ...
    'feed': {
        ...
        'ammoType': [ 'bullets.b303' ],     # 兼容的弹药Asset列表
        'reloadModes': [
            {
    ...
    'features': {
        'shoot': {
            'animation': 'shoot',
            'fireSound': 'ross_mk3.shoot',       # 射击音效，空字符串为不播放
    ...
    'slots': [
        ...
        },
        {
            ...
            'attachmentAsset': 'attachments.appearance.ross_mk3',
            'category': 'appearance_ross_mk3',                   # 槽位分类, 自由字符串
