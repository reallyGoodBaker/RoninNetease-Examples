...
Asset = {
    ...
    'bolt': {
        ...
        'boltCloseTime': 0.42,       # 枪机从完全打开回到关闭的时间
        # 通用属性：
    ...
    'feed': {
        ...
        'magazineCapacity': 6,                     # 供弹具容量 (int)
        'ammoType': [ 'bullets.carcano' ],     # 兼容的弹药Asset列表
        'reloadModes': [
            {
    ...
    'features': {
        'shoot': {
            'animation': 'shoot',
            'fireSound': 'carcano_m1891.shoot',       # 射击音效，空字符串为不播放
    ...
    'slots': [
        ...
        },
        {
            ...
            'attachmentAsset': 'attachments.appearance.carcano_m1891',
            'category': 'appearance_carcano_m1891',                   # 槽位分类, 自由字符串
